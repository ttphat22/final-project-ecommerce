<div class="best-sell">
    <div class="title ">Top best selling</div>
    <div class="content">
        @foreach($products as $product)
            <div class="item">
                <div class="item__avatar">
                    <a href="{{ route('get.product.detail',$product->pro_slug . '-'.$product->id ) }}" title="" class="image cover">
                        <img  class="lazyload lazy" src="{{ image_default() }}" style="max-width: 100%;width: 100%"  alt="Đồng hồ Diamond D" data-src="{{ pare_url_file($product->pro_avatar) }}">
                    </a>
                </div>
