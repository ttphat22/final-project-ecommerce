@if (config('layouts.pages.home.article') == 1)
	@if (isset($articlesHot) && $articlesHot)
		<section id="box-news">
			<div class="top"><a href="#" class="main-title">Article</a></div>
			<div class="bot">
...
@else
	...
	<section id="box-news" style="margin-bottom: 30px;">
		<div class="top"><a href="#" class="main-title main-title-2">Article</a></div>
		<div class="bot" style="padding: 10px;background-color: white">
			@if (isset($articlesHot[0]))
			<div class="col-6" style="width: 60%;display: flex">
				<div class="avatar" style="width: 30%">
					<a class="image" style="display: block"
					   ...
					   title="{{ $articlesHot[0]->a_name }}">
						<img class="lazyload lazy" style="height: 150px;" src="{{  asset('images/no-image') }}-{{ config('app.name') }}.jpg"
				...
				<div class="info" style="width: 60%;margin-left: 15px;">
					...
					<p class="description" style="color: #707070;overflow: hidden;
    text-overflow: ellipsis;
    display: -webkit-box;
    -webkit-line-clamp: 3;
    -webkit-box-orient: vertical;"> {{ $articlesHot[0]->a_description }}</p>
				</div>
			</div>
			@endif
