                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body block-images">
                                    <div style="margin-bottom: 10px">
                                        <img src="{{  asset('images/no-image') }}-{{ config('app.name') }}.jpg" onerror="this.onerror=null;this.src='{{ image_default() }}';" alt="" class="img-thumbnail" style="width: 200px;height: 200px;">
                                    </div>
