...
@section('content')
    ...
    <section class="content-header">
        <h1>{{  __('admin_product.category.title_update')}}</h1>
        <ol class="breadcrumb">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body block-images">
                                    <div style="margin-bottom: 10px">
                                        <img src="{{ pare_url_file($category->c_avatar ?? '') ?? '' }}" onerror="this.onerror=null;this.src='{{ image_default() }}" alt="" class="img-thumbnail" style="width: 200px;height: 200px;">
                                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="box-footer text-center">
                                ...
                                <button type="submit" class="btn btn-success">
                                    {{  __('admin_product.btn_save')}} <i class="fa fa-save"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
