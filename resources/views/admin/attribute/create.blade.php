...
@section('content')
    ...
    <section class="content-header">
        <h1>{{  __('admin_product.attribute.title_create')}}</h1>
        <ol class="breadcrumb">
                    ...
                    <form role="form" action="" method="POST">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('atb_name') ? 'has-error' : '' }}">
                                <label for="name">{{  __('admin_product.attribute.label_name')}} <span class="text-danger">(*)</span></label>
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('atb_type') ? 'has-error' : '' }}">
                                <label for="name">{{  __('admin_product.attribute.label_group')}} <span class="text-danger">(*)</span></label>
                        ...
                        <div class="col-sm-8">
                            <div class="form-group  {{ $errors->first('atb_category_id') ? 'has-error' : '' }}">
                                <label for="name">{{  __('admin_product.attribute.label_category')}} <span class="text-danger">(*)</span></label>
