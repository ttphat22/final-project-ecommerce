...
var ProductDetail = {
    init(){
        ...
        this.processReview();
        this.showTabContent();
        this.setAttributeProduct();
    },

    setAttributeProduct()
    {
        let _this = this;
        $(".js-attribute").click( function (event){
            event.preventDefault()
            let $this = $(this)
            $this.parents('.attributes-item').find(".js-attribute").removeClass('active')
            $this.addClass('active')
            // let ID = $this.attr('data-id')
            // let data = $("#attributes").val()
            _this.mapAttribute()
        })
    },
    ...
    {
        let data = []
        $('.js-attribute.active').each(function () {
